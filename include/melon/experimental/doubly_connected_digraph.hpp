...
private:
    ...
    static constexpr face INVALID_FACE = std::numeric_limits<face>::max();
    ...
    struct arc_struct {
        arc prev_boundary_arc;
        arc next_boundary_arc;
        vertex target;
        arc twin;
        face incident_face;
    };
