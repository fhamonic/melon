...
`melon/version.hpp` is the single source of truth for the version number and lets you feature-test with `MELON_VERSION`. Changes are recorded in [CHANGELOG.md](CHANGELOG.md).
