...
static_assert(std::same_as<typename iterator::iterator_category,
...
static_assert(std::derived_from<algorithm_view_interface<squares>,
                                std::ranges::view_interface<squares>>);
