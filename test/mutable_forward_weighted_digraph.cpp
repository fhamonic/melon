...
#include "melon/mutable_forward_weighted_digraph.hpp"
...
static_assert(melon::concepts::graph<mutable_forward_weighted_digraph<int>>);
static_assert(melon::concepts::incidence_list_graph<
              mutable_forward_weighted_digraph<int>>);
static_assert(melon::concepts::adjacency_list_graph<
              mutable_forward_weighted_digraph<int>>);
static_assert(
    melon::concepts::has_vertex_map<mutable_forward_weighted_digraph<int>>);

GTEST_TEST(mutable_forward_weighted_digraph, empty_constructor) {
