...
#ifndef _MSC_VER
    // Not pinned under MSVC: it ignores [[no_unique_address]] (and its own
    // [[msvc::no_unique_address]] spelling miscompiles updatable_d_ary_heap,
    // so melon does not use it), which leaves the no_state member costing 8
