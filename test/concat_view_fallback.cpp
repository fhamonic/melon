...
// detail::views::concat is std::views::concat where the standard library
// provides it, and the bundled fallback otherwise -- these tests pin the
// behavior both must share.

////////////////////////////////////////////////////////////////////////////////
// concat yields the first range's elements, then the second's
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
// an empty operand contributes nothing, on either side or both
////////////////////////////////////////////////////////////////////////////////
