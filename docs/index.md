...
Header-only and dependency-free. **C++23** is the baseline — GCC 14 and Clang 18 at minimum, GCC 15 / C++26 recommended; on macOS Apple Clang 21 (Xcode 26.4) with libc++, and on Windows both MinGW-w64 and MSVC (VS 2022 17.11 or newer) are supported. [Installation](getting-started/installation.md) has the full CI matrix, the C++23-versus-C++26 note and the MSVC note.
